...
import { useState, useCallback, forwardRef, useContext, useLayoutEffect, useRef, useMemo, createContext, Component, Fragment, useEffect } from "react";
import { createPortal } from "react-dom";
import selectStyles from "./Select.styles.js";
import { DecorativeIcon } from "../../Icon/DecorativeIcon.js";
function _typeof(o) {
...
var LoadingMessage$1 = function LoadingMessage(_ref7) {
...
var _templateObject;
var _excluded$2$1 = ["size"], _excluded2 = ["innerProps", "isRtl", "size"];
...
var Placeholder$1$1 = Placeholder$1;
...
function DummyInput(_ref3) {
  var innerRef = _ref3.innerRef, props = _objectWithoutProperties(_ref3, _excluded$2);
...
var Select$1 = /* @__PURE__ */ function(_Component) {
  ...
  _createClass(Select3, [{
    ...
    value: function renderMenu() {
      ...
      return menuPortalTarget || menuPosition === "fixed" ? /* @__PURE__ */ React.createElement(MenuPortal3, _extends({}, commonProps, {
...
function useAsync(_ref3) {
  ...
  _ref3.options;
  var _ref$isLoading = _ref3.isLoading, propsIsLoading = _ref$isLoading === void 0 ? false : _ref$isLoading, propsOnInputChange = _ref3.onInputChange, _ref$filterOption = _ref3.filterOption, filterOption = _ref$filterOption === void 0 ? null : _ref$filterOption, restSelectProps = _objectWithoutProperties(_ref3, _excluded$1);
...
function useCreatable(_ref3) {
  ...
  var options2 = useMemo(function() {
    return (allowCreateWhileLoading || !isLoading) && newOption ? createOptionPosition === "first" ? [newOption].concat(_toConsumableArray(propsOptions)) : [].concat(_toConsumableArray(propsOptions), [newOption]) : propsOptions;
  }, [allowCreateWhileLoading, createOptionPosition, isLoading, newOption, propsOptions]);
  var onChange2 = useCallback(function(newValue, actionMeta) {
...
function trim(value) {
  var _a;
  return (value == null ? void 0 : value.trim) ? (_a = value == null ? void 0 : value.trim) == null ? void 0 : _a.call(value) : value;
}
const isUnique = (isValidNewOption2) => (inputValue, option, options2) => {
  const value = trim(inputValue);
  const isValid = isValidNewOption2 ? isValidNewOption2(inputValue, option, options2) : true;
  return isValid && !!value && !options2.find((o) => o.value === value);
};
function normalizeOption({
  ...
  if (!option) {
    return valueOnly && isMulti ? [] : null;
  }
  if (option.map) {
    return option.map(
      (o) => normalizeOption({ option: o, valueOnly, isMulti })
    );
  }
  if (typeof option === typeof {}) {
    option.value = trim(option.value);
    return valueOnly ? option.value : option;
  }
  return option;
}
const getOptionByValue = (options2, value) => options2.find((option) => option.value === value);
function normalizeValue(value, options2) {
  if (!value || !options2) {
    return value;
  }
  if (typeof value === "string") {
    return getOptionByValue(options2, value);
  }
  if (value.map && typeof value[0] === "string") {
    return value.map((v) => getOptionByValue(options2, v));
  }
  return value;
}
const DropdownIndicator2 = (props) => /* @__PURE__ */ jsx$1(components.DropdownIndicator, { ...props, children: /* @__PURE__ */ jsx$1(DecorativeIcon, { name: "caret-down" }) });
const ClearIndicator2 = (props) => /* @__PURE__ */ jsx$1(components.ClearIndicator, { ...props, children: /* @__PURE__ */ jsx$1(DecorativeIcon, { name: "close", "data-testid": "react-select-clear-indicator" }) });
const Placeholder2 = (props) => /* @__PURE__ */ jsx$1(components.Placeholder, { ...props, children: props.selectProps.isLoading ? "Loading..." : props.children });
const Input2 = (props) => /* @__PURE__ */ jsx$1(
  components.Input,
  {
    ...props,
    ...props.selectProps.inputProps,
    required: props.selectProps.required && !props.hasValue
  }
);
const LoadingIndicator2 = () => /* @__PURE__ */ jsx$1(
  DecorativeIcon,
  {
    name: "gear",
    className: "!tw-text-textMuted motion-safe:tw-animate-rotate-loop"
  }
);
const MenuList2 = (props) => /* @__PURE__ */ jsxs(components.MenuList, { ...props, children: [
  props.children,
  props.isLoading && /* @__PURE__ */ jsxs("div", { className: "tw-flex tw-items-center tw-gap-2 tw-px-4 tw-py-2", children: [
    /* @__PURE__ */ jsx$1(LoadingIndicator2, {}),
    /* @__PURE__ */ jsx$1("span", { className: "tw-text-textMuted", children: props.selectProps.loadingMessage() })
  ] })
] });
const LoadingMessage2 = () => null;
const Select = forwardRef(function Select2({
  closeMenuOnSelect = true,
  components: components2 = {},
  creatable,
  createOptionPosition = "first",
  hasSearchStyles = false,
  id,
  inputProps = {},
  isClearable = false,
  isSearchable = true,
  ...
  maxLength,
  name,
  noOptionsMessage: noOptionsMessage2 = () => "No results found",
  onChange: onChange2,
  openMenuOnClick = true,
  outset = "",
  refCallback,
  ...
  const handleChange = (option, _actionMeta) => {
    const value2 = normalizeOption({
      option,
      valueOnly,
      isMulti: props.isMulti
    });
    onChange2 == null ? void 0 : onChange2(name ? { target: { name, value: value2 } } : value2);
  };
  const { isValidNewOption: isValidNewOption2 } = creatable || {};
  const commonProps = {
    backspaceRemovesValue: true,
    className: outset,
    onInputChange: (inputValue, actionMeta) => {
      const potentiallyTruncatedInputValue = !maxLength || inputValue.length <= maxLength ? inputValue : inputValue.substring(0, maxLength);
      if (props.onInputChange) {
        props.onInputChange(potentiallyTruncatedInputValue, actionMeta);
      }
      return potentiallyTruncatedInputValue;
    },
    onChange: handleChange,
    openMenuOnClick,
    value: normalizeValue(value, props.options),
    noOptionsMessage: noOptionsMessage2,
    inputId: id,
    isClearable,
    isSearchable,
    styles: styles || selectStyles(hasSearchStyles),
    // @ts-expect-error the only way to pass these to the Input component
    // without breaking seemingly random tests is to shove it onto the common props
    // that make it through as `props.selectProps`. please forgive me.
    inputProps,
    closeMenuOnSelect,
    components: {
      DropdownIndicator: DropdownIndicator2,
      ClearIndicator: ClearIndicator2,
  ...
  return creatable ? /* @__PURE__ */ jsx$1(
    CreatableSelect$1,
    {
      ref: ref || refCallback,
      ...
      ...creatable,
      ...props,
      isValidNewOption: isUnique(isValidNewOption2),
      ...commonProps
    }
  ) : loadOptions ? /* @__PURE__ */ jsx$1(
    AsyncSelect$1,
    {
      ref: ref || refCallback,
      loadOptions,
  ...
  ) : /* @__PURE__ */ jsx$1(StateManagedSelect$1, { ref: ref || refCallback, ...props, ...commonProps });
});
export {
  Select as default
};
